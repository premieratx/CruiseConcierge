...
const BLOG_FAQ_SCHEMAS: Record<string, Array<{ question: string; answer: string }>> = {
  ...
  '/blogs/lake-travis-boat-safety-essential-guidelines-for-safe-party-cruises': [
    ...
    { question: "Are your captains trained in safety procedures?", answer: "Yes! All captains hold valid captain's licenses, are CPR and first aid certified, and have years of Lake Travis experience with a 100% safety record." },
  ...
  '/blogs/safety-first-how-premiers-perfect-record-and-first-aid-training-set-us-apart': [
    ...
    { question: "What happens if the weather turns bad during our cruise?", answer: "Our licensed, experienced captains closely monitor weather conditions. If conditions become unsafe, we will dock at a safe location. We offer full rescheduling or refunds for weather-related cancellations." },
    { question: "Are your boats inspected regularly?", answer: "Yes, all our vessels undergo regular Licensed, Experienced inspections and maintenance checks. This commitment to safety is why we have a perfect safety record." },
    { question: "How experienced are your captains?", answer: "All our captains are U.S. licensed, experienced with extensive Lake Travis experience. They know every cove, shallow area, and safe anchoring spot." }
  ],
  ...
  '/blogs/is-the-atx-disco-cruise-worth-it-breaking-down-the-value-vs-a-private-boat': [
    ...
    { question: "What exactly is included in the ticket price?", answer: "Every ticket includes: 4-hour cruise, licensed, experienced captain and crew, professional DJ, professional photographer, 14 disco balls, giant lily pad floats, coolers pre-filled with ice, cups, and koozies. Tax and 20% gratuity are already baked in." },
