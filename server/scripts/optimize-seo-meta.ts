...
const seoPages: InsertSeoPage[] = [
  ...
  },
  {
    ...
    metaDescription: 'Book the ultimate bachelor party boat on Lake Travis Austin. Private cruises with premium sound, bar service & party atmosphere. Reserve today!',
    openGraphTitle: 'Austin Bachelor Party Boats | Lake Travis Cruises',
    openGraphDescription: 'Book the ultimate bachelor party boat on Lake Travis Austin. Private cruises with premium sound, bar service & party atmosphere. Reserve today!',
    openGraphType: 'website',
    twitterTitle: 'Austin Bachelor Party Boats | Lake Travis Cruises',
    twitterDescription: 'Book the ultimate bachelor party boat on Lake Travis Austin. Private cruises with premium sound, bar service & party atmosphere. Reserve today!',
    twitterCard: 'summary_large_image',
