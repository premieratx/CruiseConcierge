  ...
  return (
    <div data-page-ready="austin-bachelorette-party-december" className="min-h-screen bg-gradient-to-b from-red-50 via-white to-green-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <SEOHead 
        ...
        defaultKeywords={['December bachelorette party Austin', 'Austin bachelorette party', 'Lake Travis party boat', 'holiday bachelorette party', 'Austin nightlife December', 'Trail of Lights bachelorette']}
