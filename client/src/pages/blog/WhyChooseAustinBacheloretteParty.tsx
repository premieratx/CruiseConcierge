...
const faqs = [
  {
    ...
    answer: 'Budget $250-400 per person for a weekend. This covers accommodations, food, drinks, and activities. The ATX Disco Cruise runs $85-$105 per person all-inclusive, while private boat charters start at $800 for a 4-hour cruise. Austin is more affordable than Miami or Vegas while delivering premium experiences.'
  },
  {
    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-950">
        ...
        >
          ...
          role="img"
          aria-label="Why Choose Austin for Your Bachelorette Party - Premier Party Cruises Lake Travis"
          />
