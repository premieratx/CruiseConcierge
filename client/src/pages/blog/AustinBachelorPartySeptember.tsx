          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <LazyImage 
                  src={heroImage} 
                  alt="September bachelor party on Lake Travis" 
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                  September offers excellent availability with off-season rates. Book 3-4 weeks in advance for best selection. Our Austin bachelor party boats accommodate 14-75 guests with captain, crew, premium sound system, and water activities.
                </p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-8 mb-8">
              <p className="text-xl text-gray-700 dark:text-gray-300 mb-6">
                <strong>Shoulder season rates.</strong> Expect $600-900/person for a great weekend experience.
              </p>
