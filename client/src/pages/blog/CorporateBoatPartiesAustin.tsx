                ...
                >
                  <Card className="h-full text-center hover:shadow-lg transition-shadow border-2 hover:border-red-200">
                    <CardContent className="pt-6">
                      ...
                      <h3 className="heading-unbounded font-bold text-lg mb-2">{item.title}</h3>
            ...
            >
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="heading-unbounded text-3xl font-bold mb-6">Why Lake Travis Works for Corporate Events</h2>
                  ...
                  <div className="space-y-6">
                    {whyLakeTravisWorks.map((item, index) => (
                      <div key={index} className="flex gap-4">
                        ...
                        <div>
                          <h3 className="heading-unbounded font-bold text-lg mb-1">{item.title}</h3>
                          <p className="text-gray-600 dark:text-gray-400 text-sm">{item.description}</p>
                        </div>
                      </div>
                    ))}
        ...
        <section className="py-16 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h2 className="heading-unbounded text-3xl font-bold mb-4">What Types of Corporate Events Work Best on a Boat?</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            ...
            >
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 lg:order-2">
                  ...
                  <h2 className="heading-unbounded text-3xl font-bold mb-6">ATX Disco Cruise for Corporate Groups</h2>
            ...
            >
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="heading-unbounded text-3xl font-bold mb-6">Private Corporate Party Boats on Lake Travis</h2>
                  ...
                  <div className="mb-8">
                    <h3 className="heading-unbounded font-bold text-lg mb-4">Private corporate boats offer:</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            >
              <div className="max-w-4xl mx-auto text-center">
                ...
                <h2 className="heading-unbounded text-3xl font-bold mb-6">Alcohol at Corporate Events</h2>
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                ...
                <Card className="bg-white dark:bg-gray-800 border-2 border-amber-200">
                  <CardContent className="p-6">
                    <h3 className="heading-unbounded font-bold text-lg mb-3">Simplify with Party On Delivery</h3>
        ...
        <section className="py-16 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h2 className="heading-unbounded text-3xl font-bold mb-4">Cost Transparency (Why Finance Teams Like Boats)</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            >
              <div className="text-center mb-12">
                ...
                <h2 className="heading-unbounded text-3xl font-bold mb-4">Safety, Compliance, and Professionalism</h2>
        ...
        <section className="py-16 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h2 className="heading-unbounded text-3xl font-bold mb-4">Ideal Corporate Event Formats on the Water</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <motion.div
              ...
              className="text-center mb-12"
            >
              <h2 className="heading-unbounded text-3xl font-bold mb-4">FAQs – Corporate Boat Parties in Austin</h2>
