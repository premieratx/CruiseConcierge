  ...
  return (
    <>
      <SEOHead
        ...
        defaultKeywords={['August bachelorette party Austin', 'Austin bachelorette party', 'Lake Travis party boat', 'summer bachelorette party', 'Austin nightlife August', 'girls trip Austin']}
