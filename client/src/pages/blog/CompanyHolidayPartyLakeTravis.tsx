...
export default function CompanyHolidayPartyLakeTravis() {
  ...
  return (
    ...
    <>
      <SEOHead 
        pageRoute="/blogs/company-holiday-party-lake-travis"
        defaultTitle="How to Throw the Perfect Company Holiday Party on Lake Travis | Austin Corporate Celebrations"
        defaultDescription="Plan the ultimate company holiday party Austin experience on Lake Travis. Corporate holiday party boat rentals for 14-75 guests. BYOB, catering coordination, and stunning sunset views."
        defaultKeywords={['company holiday party Austin', 'corporate holiday party Lake Travis', 'holiday boat party Austin', 'Lake Travis holiday celebration', 'Austin corporate Christmas party', 'holiday office party boat']}
      ...
      <div className="min-h-screen bg-white dark:bg-gray-950">
        ...
        >
          ...
          role="img"
          aria-label="How to Throw the Perfect Company Holiday Party on Lake Travis - Premier Party Cruises Lake Travis"
          />
