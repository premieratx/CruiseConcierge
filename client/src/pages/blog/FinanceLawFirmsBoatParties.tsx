...
const faqs = [
  ...
  },
  {
    ...
    answer: 'For finance team building Lake Travis events, we recommend: Day Tripper (14 guests) for executive teams, Meeseeks (25 guests) for department events, Clever Girl (50 guests) for division gatherings, and The Irony (75 guests) for full company events.'
  },
  {
...
const packageOptions = [
  ...
  { name: 'The Irony', capacity: '75 guests', best: 'Company-wide celebrations', icon: Landmark }
];
