    ...
    >
      ...
      <SectionReveal>
        <section id="choosing-boat" className="mb-12" data-testid="section-choosing-boat">
          ...
          <p className="text-lg mb-4 text-gray-700 dark:text-gray-300">
            With <strong>14+ years of experience and 125,000+ satisfied customers</strong>, Premier Party Cruises 
      ...
      <div className="my-12 bg-gradient-to-r from-brand-blue to-purple-600 text-white p-8 rounded-lg text-center">
        ...
        <p className="text-lg mb-8">
          <strong>14+ years of experience. 125,000+ happy customers. Perfect safety record.</strong>
        </p>
