...
export default function CompanyParty75People() {
  ...
  return (
    ...
    <>
      ...
      <BlogV2Layout
        title="75 Person Corporate Event Austin | Large Company Party Lake Travis Boat"
        description="Host the ultimate 75 person corporate event Austin on Lake Travis. Our Clever Girl flagship boat holds 75 guests with 14 disco balls and giant Texas flag. Book your corporate bash boat Austin today!"
        slug="company-party-75-people-austin"
