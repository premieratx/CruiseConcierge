...
// Milestone Birthday packages - REAL packages only (Standard, Essentials, Ultimate)
const birthdayPackages = [
  {
    ...
    subtitle: 'The boat, the captain, and the lake - make this milestone birthday unforgettable',
    features: [
            ...
            {showQuoteBuilder && (
              ...
              >
                <div className="max-w-7xl mx-auto">
                  ...
                  >
                    <EmbeddedQuoteFlow source="milestone_birthday_embed" />
                  </motion.div>
                </div>
              </motion.div>
            )}
