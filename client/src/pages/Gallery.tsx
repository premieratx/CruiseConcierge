      ...
      <section className="py-12 bg-gradient-to-b from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-950">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <SectionReveal>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {[
                { src: '/attached_assets/bachelor-party-group-guys.webp', alt: 'Bachelor party group celebrating on Lake Travis' },
                { src: '/attached_assets/atx-disco-cruise-party.jpg', alt: 'ATX Disco Cruise party with guests dancing' },
                { src: '/attached_assets/dancing-party-scene.jpg', alt: 'Party guests dancing on the cruise' },
                { src: '/attached_assets/party-atmosphere-1.jpg', alt: 'Party atmosphere with friends celebrating' },
                ...
                { src: '/attached_assets/clever-girl-8-wedding-reception.jpg', alt: 'Wedding reception party on the boat' },
                { src: '/attached_assets/clever-girl-3-bachelorette-boat.jpg', alt: 'Bachelorette group on party boat' },
                { src: '/attached_assets/bachelor-party-group-guys.jpg', alt: 'Bachelor party group photo' },
                { src: '/attached_assets/atx-disco-cruise-party.webp', alt: 'Disco cruise party celebration' },
                { src: '/attached_assets/dancing-party-scene.webp', alt: 'Dancing and celebration on the cruise' },
                { src: '/attached_assets/party-atmosphere-1.webp', alt: 'Lake Travis party cruise celebration' },
                { src: '/attached_assets/party-atmosphere-2.webp', alt: 'Party boat guests having fun' },
                { src: '/attached_assets/party-atmosphere-3.webp', alt: 'Group celebrating on party boat' },
                { src: '/attached_assets/bachelor-party-group-guys-hero.webp', alt: 'Bachelor party hero celebration' },
                { src: '/attached_assets/bachelor-party-group-guys-hero-compressed.webp', alt: 'Bachelor party group fun' },
                { src: '/attached_assets/bachelor-party-group-guys-optimized.webp', alt: 'Bachelor party on Lake Travis' },
              ].map((photo, idx) => (
                <Card
                  key={idx}
                  className="group cursor-pointer overflow-hidden hover:shadow-xl transition-all duration-300 p-0 rounded-xl"
