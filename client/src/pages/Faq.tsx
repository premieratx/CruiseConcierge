    ...
    items: [
      {
        ...
        answer: (
          <>
            ...
            exclusive groups of 14-75 guests starting at $200/hour, and the <Link href="/atx-disco-cruise" className="text-primary hover:underline">ATX 
    ...
    items: [
      {
        ...
        answer: 'Private boats start at $200/hour (4-hour minimum) for up to 14 guests. Larger boats range $225-300/hour. The ATX Disco Cruise costs $85-105 per person including DJ, photographer, and amenities. Groups of 16+ get the bride/groom FREE on premium packages. Best value in Austin!'
      },
      {
...
export default function Faq() {
  return (
    <>
      <SEOHead 
        pageRoute="/faq"
        defaultTitle="Frequently Asked Questions | Lake Travis Boat Rentals | Austin Party Cruises"
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-12">
              <Card className="p-4 hover:shadow-lg transition-shadow cursor-pointer">
                <a href="tel:512-900-1821" className="flex items-center space-x-3">
                  <div className="p-2 bg-green-100 dark:bg-green-900 rounded-lg">
                    <Phone className="w-5 h-5 text-green-600 dark:text-green-400" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Call Us</p>
                    <p className="font-semibold">(512) 900-1821</p>
                  </div>
                </a>
              </Card>
              
              <Card className="p-4 hover:shadow-lg transition-shadow cursor-pointer">
                <a href="mailto:info@premierpartycruises.com" className="flex items-center space-x-3">
                  <div className="p-2 bg-blue-100 dark:bg-blue-900 rounded-lg">
                    <Mail className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Email Us</p>
                    <p className="font-semibold text-sm">info@premierpartycruises.com</p>
                  </div>
                </a>
              </Card>
            ...
            {faqCategories.map((category, index) => (
              ...
              >
                <FAQ 
                  categories={[category]}
                  showCategories={true}
                  defaultOpenItems={index === 0 ? ['0-0-' + category.items[0].id] : []}
                />
              </div>
            ))}
          </div>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-primary to-primary-dark text-white">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Our friendly team is here to help you plan the perfect Lake Travis experience
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-white/20">
              <p className="text-sm uppercase tracking-wide mb-4 text-white/80">Popular Services</p>
              <div className="flex flex-wrap justify-center gap-4 text-sm">
                <Link href="/bachelor-party-austin" className="hover:underline text-white/90">Bachelor Parties</Link>
                <span className="text-white/40">•</span>
                <Link href="/bachelorette-party-austin" className="hover:underline text-white/90">Bachelorette Parties</Link>
                <span className="text-white/40">•</span>
                <Link href="/atx-disco-cruise" className="hover:underline text-white/90">ATX Disco Cruise</Link>
                <span className="text-white/40">•</span>
                <Link href="/private-cruises" className="hover:underline text-white/90">Private Charters</Link>
                <span className="text-white/40">•</span>
                <Link href="/corporate-events" className="hover:underline text-white/90">Corporate Events</Link>
              </div>
            </div>
          </div>
        </section>
