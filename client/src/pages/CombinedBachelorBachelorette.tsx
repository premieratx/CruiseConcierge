...
import { 
  ...
  Gem, Flower, Flower2, CircleDot, Smile, X
} from 'lucide-react';
...
const testimonials = [
  ...
  },
  {
    ...
    location: 'Dallas, TX',
    rating: 5,
    text: "Our friends are basically one big crew anyway, so a combined party made perfect sense. Lake Travis was GORGEOUS, the boat had room for everyone, and the vibe was incredible. Both of us cruised free too!",
    avatar: '👫',
    package: 'Party Squad Package'
  },
  {
...
// Photo gallery items
const galleryPhotos = [
  { id: 1, src: heroImage2, alt: 'Combined bachelor bachelorette party on Lake Travis' },
  { id: 2, src: heroImage3, alt: 'Friends dancing on the cruise' },
  { id: 3, src: galleryImage1, alt: 'Mixed group party vibes' },
  { id: 4, src: floatImage, alt: 'Party floats on the water' },
  { id: 5, src: galleryImage2, alt: 'Combined party atmosphere' },
  { id: 6, src: boatImage1, alt: 'Day Tripper boat' },
  { id: 7, src: galleryImage3, alt: 'Lake Travis celebration' },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <SEOHead
        ...
        defaultTitle="Combined Bachelor Bachelorette Party Austin | Lake Travis Boat Parties"
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <img 
                ...
                alt="Combined Bachelor Bachelorette Party Lake Travis"
