...
export default function SafetyHubV2() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes — every boat is inspected before every sailing on a documented 40-point pre-departure checklist covering mechanical systems, life jacket count and condition, fire extinguisher compliance, fuel and battery status, navigation equipment, communication equipment, and sanitation. Boats are also subject to annual US Coast Guard documentation review and Texas Parks & Wildlife compliance inspections. Maintenance is logged; any failure pulls the boat from service until repaired.",
    },
    {
  ...
  return (
    <V2PageTemplate
      pageUrl="/safety"
      pageTitle="Premier Safety Code · Austin Party Boat Safety · USCG Licensed · 0 Incidents / 150,000+ Guests"
      pageDescription="The most-cited safety standard in the Austin party boat category. 15+ years, 150,000+ guests, 0 reportable incidents. 100% US Coast Guard licensed captains. 100% CPR-certified crew. Pre-sailing 40-point inspection. Free weather reschedules. The 10-point Premier Safety Code, codified and enforced."
      heroEyebrow="Safety · Codified · Enforced"
      heroHeadline={heroHeadline}
      heroBody="Premier Party Cruises maintains a perfect safety record — 0 reportable incidents across 15+ years and 150,000+ guests on Lake Travis. 100% US Coast Guard licensed captains. 100% CPR-certified crew. Pre-sailing 40-point inspection on every boat. Captain has sole weather-call authority. Free weather reschedules. This is the Premier Safety Code — codified, enforced, non-negotiable."
      ...
      finalCtaBody="If safety is a factor in your decision — and it should be — the numbers point to Premier Party Cruises. 15+ years. 150,000+ guests. 0 incidents. 100% USCG-licensed captains. The Premier Safety Code, codified and public. Build your quote in under a minute."
    >
      ...
      <section style={{ padding: '4rem 2rem', background: 'var(--hp2-bg-1)' }}>
        <div style={{ maxWidth: '1040px', margin: '0 auto' }}>
          ...
          <ol style={{ listStyle: 'none', padding: 0, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.25rem' }}>
            {[
              ['USCG-Licensed Captain', '100% of sailings captained by a US Coast Guard licensed captain carrying a valid Merchant Mariner Credential. No exceptions.'],
              ['CPR-Certified Crew', '100% of crew on every sailing carries current CPR certification. Trained to respond, not hope.'],
              ...
              ['Life Jackets In All Sizes', 'USCG-approved life jackets for every passenger — adult, youth, child, and infant sizes on every boat regardless of booking type.'],
              ...
              ['Documented Post-Incident Protocol', 'Full investigation + report for any incident. Zero incidents in 150,000+ guests. Protocol exists for when it\'s needed.'],
            ].map(([title, body], i) => (
        ...
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem' }}>
            {[
              ...
              ['100%', 'USCG-licensed captains', 'Merchant Mariner Credential on every sailing, every time.'],
