...
export default function GoldenTicketPrivate() {
  ...
  return (
    <>
      ...
      <div data-page-ready="golden-ticket-private" className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-amber-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      {/* Main Content Area */}
        ...
        <div className="w-full max-w-6xl px-4">
          ...
          >
            ...
            >
              ...
              {/* Section 3: Bachelor/Bachelorette Note */}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg md:text-xl font-medium">
                      Planning a bachelor or bachelorette party? Book a Private Cruise for the ultimate customized party experience! 🎉
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <a 
                href="https://gamma.app/docs/vtbx5l9gki6o5mn" 
                target="_blank" 
              ...
              <iframe 
                src="https://gamma.app/embed/vtbx5l9gki6o5mn" 
