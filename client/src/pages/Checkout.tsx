...
const stripePromise = loadStripe(import.meta.env.VITE_STRIPE_PUBLIC_KEY || import.meta.env.TESTING_VITE_STRIPE_PUBLIC_KEY || '');
...
export default function Checkout() {
  ...
  const fetchQuoteAndCreatePaymentIntent = async () => {
    try {
      ...
      } else if (import.meta.env.VITE_STRIPE_PUBLIC_KEY || import.meta.env.TESTING_VITE_STRIPE_PUBLIC_KEY) {
  ...
  if (!(import.meta.env.VITE_STRIPE_PUBLIC_KEY || import.meta.env.TESTING_VITE_STRIPE_PUBLIC_KEY) || !clientSecret) {
    return (
