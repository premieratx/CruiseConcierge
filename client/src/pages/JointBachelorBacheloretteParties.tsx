      ...
      <SectionReveal>
        <section id="private-options" className="py-16 bg-gradient-to-b from-white to-blue-50 dark:from-gray-950 dark:to-gray-900">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="prose prose-lg max-w-none dark:prose-invert mb-8">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                For larger groups or those wanting complete privacy, <Link href="/private-cruises" className="text-blue-600 hover:text-blue-700 font-semibold">private boat rentals</Link> offer the ultimate <strong>bachelor bachelorette boat party</strong> experience! With <strong>$1,050-$2,660 for a 4-hour cruise</strong> depending on boat size and package, you get exclusive use of the boat for your <strong>combined bachelor bachelorette</strong> celebration. Private cruises work perfectly for groups of 14-75 guests, giving you complete control over music, itinerary, decorations, and timing for your <strong>austin co-ed bachelor party</strong>.
              </p>
              
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Private boats shine for <strong>joint bach party austin</strong> groups that want customization and exclusivity. You can coordinate catering with your favorite restaurants, create custom playlists, plan surprise activities for the couple, and even arrange special moments like proposal reenactments or wedding party reveals during your <strong>lake travis combined celebration</strong>. Many couples split the cost among all attendees, making private boats surprisingly affordable for larger <strong>combined pre-wedding party</strong> groups!
              </p>
            </div>
