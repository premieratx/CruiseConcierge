      ...
      <section className="hp2-hero">
        ...
        <div className="hp2-hero__content">
          ...
          <p className="hp2-hero__body">
            DJ. Photographer. Dance floor. Crystal-clear swimming. Giant floats. The ATX Disco Cruise is the #1 bachelorette activity in Austin — from $85/person with everything included. Or go exclusive with a private charter.
          </p>
