    ...
    >
      ...
      <section className="hp2-section">
        ...
        <div style={{ marginTop: '2rem' }}>
          <p className="hp2-section__body">
            Related: <a href="/bachelorette-party-austin" style={{ color: 'var(--hp2-gold)', textDecoration: 'underline' }}>Main bachelorette page</a> · <a href="/3-day-austin-bachelorette-itinerary" style={{ color: 'var(--hp2-gold)', textDecoration: 'underline' }}>3-day itinerary</a> · <a href="/top-10-austin-bachelorette-ideas" style={{ color: 'var(--hp2-gold)', textDecoration: 'underline' }}>Top 10 bachelorette ideas</a> · <a href="/luxury-austin-bachelorette" style={{ color: 'var(--hp2-gold)', textDecoration: 'underline' }}>Luxury guide</a> · <a href="/budget-austin-bachelorette" style={{ color: 'var(--hp2-gold)', textDecoration: 'underline' }}>Budget guide</a> · <a href="/austin-bachelorette-nightlife" style={{ color: 'var(--hp2-gold)', textDecoration: 'underline' }}>Nightlife guide</a>
          </p>
        </div>
      </section>
    </V2PageTemplate>
