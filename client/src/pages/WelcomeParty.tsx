...
import { 
  ...
  Anchor, Sun, Info, TrendingUp, Plane, Heart, Smile
} from 'lucide-react';
...
const welcomePackages = [
  {
    ...
    name: 'Casual Welcome',
    basePrice: 425,
    description: 'Perfect meet & greet for out-of-town guests',
    features: [
      'Premium pontoon boat (25-30 guests)',
      'Professional captain and crew',
      'Afternoon or evening cruise options',
      'Texas BBQ catering setup',
  ...
  },
  {
    ...
    basePrice: 525,
    addOnPrice: 75,
    description: 'Enhanced welcome experience with live music',
    features: [
      'Everything in Casual Welcome',
      'Upgraded yacht (50 guests)',
      'Live acoustic musician',
      'Premium Texas BBQ or Fajita bar',
      'Open bar setup area',
      'Welcome gift bags station',
