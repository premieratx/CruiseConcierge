...
const sweet16Packages = [
  {
    id: 'sweet_essential',
    name: 'Sweet Essential',
    basePrice: 395,
    description: 'Perfect sweet 16 celebration essentials',
    features: [
      'Premium pontoon boat (25-30 guests)',
      'Professional captain and crew',
      '3-4 hour birthday cruise',
      'Sweet 16 decorations and banners',
      'DJ with teen-friendly playlist',
      'Mocktail bar setup',
      'Instagram photo station',
  ...
  },
  {
    ...
    basePrice: 495,
    addOnPrice: 75,
    description: 'Enhanced sweet 16 with all the extras',
    features: [
      'Everything in Sweet Essential',
      'Upgraded yacht (50 guests)',
      'Professional photographer (2 hours)',
      'Custom pink & gold decorations',
      'Live DJ with requests',
      'Specialty mocktails menu',
      'TikTok/Instagram props',
  ...
  },
  {
    ...
    basePrice: 625,
    addOnPrice: 125,
    description: 'Ultimate luxury sweet 16 experience',
    features: [
      'Everything in Sweet Deluxe',
      'Luxury yacht (75 guests)',
      'Full photography & videography',
      'Custom themed decorations',
      'Celebrity-style DJ setup',
      'Gourmet dessert bar',
      'Red carpet entrance',
      'Fireworks display option',
      'VIP deck for birthday girl'
    ],
    popular: false,
    icon: Sparkles,
