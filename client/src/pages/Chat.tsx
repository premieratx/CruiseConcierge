...
import { Ship, Calendar, Users, Clock, ChevronRight, ArrowLeft } from 'lucide-react';
...
type ChatStep = 'welcome' | 'event-type' | 'contact-info' | 'event-details' | 'complete';
  ...
  const createLead = useMutation({
    mutationFn: async (data: typeof formData) => {
      ...
      const project: InsertProject = {
        ...
        groupSize: parseInt(data.groupSize) || null,
        eventType: data.eventType,
        specialRequests: data.specialRequests || null,
        preferredTime: data.preferredTime || null,
        budget: data.budget ? Math.round(parseFloat(data.budget) * 100) : null,
        leadSource: 'chat',
      };
