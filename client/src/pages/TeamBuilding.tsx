...
import heroImage1 from '@assets/image_1757877906674.png';
import heroImage2 from '@assets/image_1757884902886.png';
import heroImage3 from '@assets/image_1757886911506.png';
...
const teamBuildingPackages = [
  {
    ...
    name: 'Basic Team Day',
    basePrice: 450,
    description: 'Essential team building experience on the water',
    features: [
      'Premium pontoon boat (25-30 people)',
      'Professional captain and crew',
      '3-4 hour team building cruise',
      'Basic team challenges and activities',
  ...
  {
    id: 'enhanced_team',
    name: 'Enhanced Team Experience',
    basePrice: 550,
    addOnPrice: 75,
    description: 'Comprehensive team building with facilitated activities',
    features: [
      'Everything in Basic Team Day',
      'Upgraded yacht (50 people)',
      'Professional team building facilitator',
      'Custom team challenges and competitions',
      'Awards and recognition ceremony',
      'Team building workbook materials',
      'Lunch or dinner catering setup',
      'Extended cruise time available'
    ],
    popular: true,
    icon: Trophy,
    badge: 'Most Popular'
  },
  {
    ...
    basePrice: 750,
    addOnPrice: 150,
    description: 'Premium leadership and team development experience',
    features: [
      'Everything in Enhanced Experience',
      'Luxury yacht (75 people)',
      'Executive team building specialist',
      'Leadership development activities',
      'Strategic planning sessions',
      'Gourmet catering and premium bar',
      'Professional photography/videography',
      'Custom company branding throughout',
      'Post-event report and insights'
    ],
    popular: false,
    icon: Sparkles,
