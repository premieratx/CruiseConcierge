...
const whatsIncluded = [
  ...
  },
  {
    ...
    description: 'Choose your party package and we\'ll have everything ready - coolers (BYO ice, or order pre-iced from Party On Delivery, our sister company), cups, tables, and more'
  },
  {
    icon: MapPin,
...
export default function TeamBuilding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white" data-page-ready="team-building">
      <SEOHead 
