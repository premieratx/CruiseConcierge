...
const eventTypes = [
  { id: 'birthday', label: 'Birthday', emoji: '🎂', color: 'bg-pink-500' },
  { id: 'bachelor', label: 'Bachelor', emoji: '🎉', color: 'bg-blue-500' },
  { id: 'bachelorette', label: 'Bachelorette', emoji: '💃', color: 'bg-purple-500' },
  { id: 'corporate', label: 'Corporate', emoji: '💼', color: 'bg-gray-500' },
  { id: 'wedding', label: 'Wedding', emoji: '💒', color: 'bg-rose-500' },
  { id: 'graduation', label: 'Graduation', emoji: '🎓', color: 'bg-green-500' },
  { id: 'other', label: 'Other', emoji: '🎊', color: 'bg-yellow-500' },
];
