...
// Client Entertainment packages - REAL packages only (Standard, Essentials, Ultimate)
const clientPackages = [
  {
    ...
    subtitle: 'The boat, the captain, and the lake - impress and entertain in style',
    features: [
              ...
              {showQuoteBuilder && (
                ...
                >
                  <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
                    <EmbeddedQuoteFlow source="client_entertainment_embed" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
