...
const rehearsalPackages = [
  {
    ...
    basePrice: 450,
    description: 'Perfect for close family and wedding party',
    features: [
      'Premium 25-30 person pontoon boat',
      'Professional captain and crew',
      'Sunset cruise timing (golden hour)',
      'Champagne toast setup',
      'Bluetooth sound system for speeches',
  ...
  },
  {
    ...
    basePrice: 550,
    addOnPrice: 75,
    description: 'Ideal for traditional rehearsal dinner',
    features: [
      'Everything in Intimate Package',
      'Upgraded 50-person yacht',
      'Professional photography hour',
      'Premium sound system with wireless mics',
      'Catering setup assistance',
      'Special bride & groom seating area',
      'Complimentary decorations package',
      'Extended cruise time option'
    ],
    popular: true,
    icon: Crown,
    badge: 'Most Popular'
