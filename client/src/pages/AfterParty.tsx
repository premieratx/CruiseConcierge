...
const afterPartyPackages = [
  {
    ...
    features: [
      'Premium party boat (25-30 guests)',
      'Professional DJ and dance floor',
      'Late night cruise (10pm-1am)',
      'Premium sound and lighting',
      'Midnight champagne toast',
      'Late night snacks station',
      'Coolers with ice',
      'Party atmosphere lighting'
    ],
    popular: false,
    icon: Disc3,
  ...
  },
  {
    ...
    basePrice: 575,
    addOnPrice: 75,
    description: 'Enhanced after party with premium amenities',
    features: [
      'Everything in Dance Party',
      'Upgraded yacht (50 guests)',
      'Professional DJ with requests',
      'LED dance floor',
      'Premium bar setup',
      'Dessert and coffee bar',
      'Lounge seating area',
      'Extended cruise available'
    ],
    popular: true,
    icon: Crown,
    badge: 'Most Popular'
  ...
  {
    id: 'ultimate_sendoff',
    name: 'Ultimate Send-off',
    basePrice: 675,
    addOnPrice: 150,
    description: 'The ultimate wedding after party experience',
    features: [
      'Everything in Premium Celebration',
      'Luxury yacht (75 guests)',
      'Celebrity DJ experience',
      'Full LED party lighting',
      'Premium open bar service',
      'Gourmet late night menu',
      'VIP bride & groom deck',
