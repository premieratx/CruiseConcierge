    ...
    <div className="min-h-screen bg-white dark:bg-brand-black">
      ...
      <section id="booking-widget" className="py-24 bg-white dark:bg-gray-950">
        <div className="container mx-auto px-6">
          ...
          >
            <motion.div variants={fadeInUp}>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Get started with our instant quote builder and book your unforgettable bachelorette party cruise.
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            <Chat defaultEventType="bachelorette" />
          </motion.div>
        </div>
      </section>
