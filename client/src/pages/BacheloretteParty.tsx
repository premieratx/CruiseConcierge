        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-4">
            {[
              ...
              { q: "What is the cancellation policy?", a: "Fair refund policy — all weather-caused cancellations get FREE reschedules, always. We offer a 48-hour full refund window from the time of booking. After 48 hours, deposits are committed to your date but you can reschedule once within the same season with reasonable notice. The captain calls weather cancellations and we reschedule those 100% free." },
              ...
              { q: "What makes Premier Party Cruises the best bachelorette option in Austin?", a: "We're the only Lake Travis cruise company with a professional on-board photographer included at no extra cost on the Disco Cruise. With 15+ years operating on Lake Travis, 150,000+ guests served, a perfect safety record, and licensed, experienced captains, we're Austin's most trusted bachelorette party boat. Groups fly in from across the country specifically for this experience." },
            ].map((faq, idx) => (
