...
import { QuoteBuilderHeader } from "@/lead-app/components/quote-builder/QuoteBuilderHeader";
import { DateSelector } from "@/lead-app/components/quote-builder/DateSelector";
import { PartyTypeSelector } from "@/lead-app/components/quote-builder/PartyTypeSelector";
import { GuestCountSelector } from "@/lead-app/components/quote-builder/GuestCountSelector";
import { SelectionSummaryHeader } from "@/lead-app/components/quote-builder/SelectionSummaryHeader";
import { DiscoCruiseSelectorV2 } from "@/lead-app/components/quote-builder/DiscoCruiseSelectorV2";
import { PrivateCruiseSelector } from "@/lead-app/components/quote-builder/PrivateCruiseSelector";
import { LeadCaptureForm } from "@/lead-app/components/quote-builder/LeadCaptureForm";
...
import { EOYSaleBanner } from "@/lead-app/components/quote-builder/EOYSaleBanner";
...
import { useQuoteAnalytics } from "@/lead-app/hooks/useQuoteAnalytics";
import { useAbandonedBookingTracking } from "@/lead-app/hooks/useAbandonedBookingTracking";
import { validateDiscoSlot } from "@/lead-app/lib/discoRules";
...
import { Popover, PopoverContent, PopoverTrigger } from "@/lead-app/components/ui/popover";
import { cn } from "@/lead-app/lib/utils";

// Lazy load non-critical components for faster initial render when embedded
const HeroSection = lazy(() => import("@/lead-app/components/HeroSection").then(m => ({ default: m.HeroSection })));
const AlternativeDatesSelector = lazy(() => import("@/lead-app/components/quote-builder/AlternativeDatesSelector").then(m => ({ default: m.AlternativeDatesSelector })));
const PricingComparison = lazy(() => import("@/lead-app/components/quote-builder/PricingComparison").then(m => ({ default: m.PricingComparison })));
const SmallerBoatSuggestion = lazy(() => import("@/lead-app/components/quote-builder/SmallerBoatSuggestion").then(m => ({ default: m.SmallerBoatSuggestion })));
