...
import { DiscoCruiseSelector } from "@/lead-app/components/quote-builder/DiscoCruiseSelector";
...
const ScrollingBackground = lazy(() => import("@/lead-app/components/ScrollingBackground").then(m => ({ default: m.ScrollingBackground })));
