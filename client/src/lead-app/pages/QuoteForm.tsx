...
const QuoteForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { getAffiliateData, getAffiliateLandingUrl } = await import("@/lead-app/lib/affiliateTracking");
      ...
      const { trackAffiliateConversion } = await import("@/lead-app/lib/affiliateTracking");
