...
import { PayInFullPerksBanner } from "@/lead-app/components/pricing/PayInFullPerksBanner";
...
// Meeseeks/Irony photos (15-30 guests) - using existing assets
...
// Clever Girl photos (31+ guests) - using existing assets
...
export const JanuaryPrivateCruisePricingCalculator = () => {
  ...
  return (
    <Card className="w-full max-w-full sm:max-w-[95vw] mx-auto">
      ...
      <CardContent className="space-y-1.5 py-1.5 px-2.5">
        ...
        <PayInFullPerksBanner variant="private" />
        ...
        <div className="bg-accent/30 rounded-lg p-2 border-2 border-yellow-500">
          ...
          >
            ...
            <div className="flex items-center gap-2 p-2 bg-white/50 rounded-lg border border-gray-200 sm:flex-col sm:p-0 sm:bg-transparent sm:border-0 sm:rounded-none">
              <RadioGroupItem value="none" id="no-discount-private" className="shrink-0" />
              <Label htmlFor="no-discount-private" className="text-xs sm:text-sm cursor-pointer font-semibold leading-tight">
