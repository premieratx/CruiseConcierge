...
import { Switch } from "@/lead-app/components/ui/switch";
import { Badge } from "@/lead-app/components/ui/badge";
import { Input } from "@/lead-app/components/ui/input";
import { Label } from "@/lead-app/components/ui/label";
import { ShoppingCart, Plus, Minus, Send, Loader2 } from "lucide-react";
import { toast } from "@/lead-app/hooks/use-toast";
import { supabase } from "@/lead-app/integrations/supabase/client";

// Add-on photo imports

import mimosaBarImg from "@/lead-app/assets/addons/mimosa-bar.jpg";
import oldFashionedImg from "@/lead-app/assets/addons/old-fashioned.jpg";
import brunchBarImg from "@/lead-app/assets/addons/brunch-bar.jpg";
import bloodyMaryImg from "@/lead-app/assets/addons/bloody-mary.jpg";
import shotBarImg from "@/lead-app/assets/addons/shot-bar.jpg";
import groceryDeliveryImg from "@/lead-app/assets/addons/grocery-delivery.jpg";
import djImg from "@/lead-app/assets/addons/dj.jpg";
import bartenderImg from "@/lead-app/assets/addons/bartender.jpg";
import hibachiImg from "@/lead-app/assets/addons/hibachi.jpg";
import massageImg from "@/lead-app/assets/addons/massage.jpg";
import discoBallImg from "@/lead-app/assets/addons/disco-ball.jpg";
import partyBusImg from "@/lead-app/assets/addons/party-bus.jpg";
...
export const ADD_ON_CATEGORIES: CategoryGroup[] = [
  {
    ...
    color: "purple",
    items: [
      { name: "Mimosa Bar Setup", description: "Champagne, fresh juices (OJ, cranberry, grapefruit), and champagne flutes for the whole crew", icon: "🥂", price: 125, type: "toggle", image: mimosaBarImg.src },
      { name: "Old Fashioned Bar Setup", description: "Classic Old Fashioned bar with bourbon, bitters, simple syrup, orange peels & cherries", icon: "🥃", price: 150, type: "toggle", image: oldFashionedImg.src },
      { name: "Tequila Bar Setup", description: "100% agave tequila, fresh limes, grapefruit liqueur, Topo Chico, margarita salt, shot glasses & cocktail glasses", icon: "🍋", price: 175, type: "toggle", image: brunchBarImg.src },
      { name: "Bloody Mary Bar Setup", description: "Vodka, Bloody Mary mix, celery, olives, hot sauce, bacon & all the fixings", icon: "🍅", price: 125, type: "toggle", image: bloodyMaryImg.src },
      { name: "Shot Bar Setup", description: "Tequila, whiskey, or vodka shots with limes, salt, and chasers — ready to go", icon: "🥂", price: 100, type: "toggle", image: shotBarImg.src },
      { name: "Grocery Delivery & Stocking", description: "We'll shop, deliver, and stock your fridge & pantry before you arrive", icon: "🛒", price: 75, type: "toggle", image: groceryDeliveryImg.src },
    ],
  },
  {
    ...
    color: "sky",
    items: [
      { name: "Professional DJ", description: "Live DJ to keep the party going at your suite — speakers, lights & playlist curation included", icon: "🎧", price: 600, type: "toggle", image: djImg.src },
      { name: "Bartender Service", description: "Professional bartender to serve drinks at your suite party — 4 hour minimum", icon: "🍸", price: 400, type: "quantity", maxQty: 2, image: bartenderImg.src },
      { name: "Hibachi Chef Experience", description: "Private hibachi chef cooks right at your suite — full dinner for the whole group", icon: "🔥", price: 800, type: "toggle", image: hibachiImg.src },
      { name: "Massage Service", description: "Licensed massage therapist comes to your suite — 60-minute sessions per person", icon: "💆", price: 150, type: "quantity", maxQty: 10, image: massageImg.src },
      { name: "Transportation Arrangements", description: "Sprinter vans to party buses — we can arrange transportation throughout your stay", icon: "🚐", price: 200, type: "toggle", image: partyBusImg.src },
      { name: "Disco Ball Rental", description: "Motorized disco ball with LED lighting to transform your suite into a dance floor", icon: "🪩", price: 75, type: "toggle", image: discoBallImg.src },
    ],
  },
];
