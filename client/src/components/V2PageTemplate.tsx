...
const DEFAULT_QUICK_LINKS = [
  ...
  { title: 'Austin Party Boat', href: '/party-boat-austin', primary: true },
  { title: 'Lake Travis Party Boat', href: '/party-boat-lake-travis', primary: true },
  { title: 'Party Boat Rentals', href: '/private-cruises', primary: true },
  ...
  { title: 'Austin Corporate Event Party Boat', href: '/corporate-events' },
  { title: 'Austin Wedding Party Boat', href: '/wedding-parties' },
  { title: 'Austin Birthday Party Boat', href: '/birthday-parties' },
  { title: 'Plan Your Trip', href: '/plan-your-trip' },
  { title: 'Premier Safety Code', href: '/safety' },
  { title: 'Premier vs ATX Party Boats', href: '/premier-vs-austin-party-boat' },
  { title: 'Premier vs Float On', href: '/premier-vs-float-on' },
  { title: 'Best Austin Party Boat Guide', href: '/best-austin-party-boat' },
  { title: 'Party Boat Pricing Guide', href: '/austin-party-boat-pricing-guide' },
  { title: 'Austin Bachelorette Itinerary', href: '/austin-bachelorette-itinerary' },
  { title: 'Austin Bachelor Itinerary', href: '/austin-bachelor-itinerary' },
