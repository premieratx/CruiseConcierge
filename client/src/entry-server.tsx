...
async function preloadBlogModule(url: string): Promise<void> {
  ...
  const blogModules: Record<string, () => Promise<any>> = {
    ...
    'austin-bachelorette-weekend-alcohol-timeline-day-by-day-drinking-strategy-for-multi-day-celebrations': () => import('./pages/blog/AustinBacheloretteAlcoholTimeline'),
    'client-entertainment-alcohol-strategy-impressing-without-overdoing-it': () => import('./pages/blog/ClientEntertainmentAlcoholStrategy'),
    'conference-after-party-alcohol-coordination-sxsw-acl-and-austin-event-integration': () => import('./pages/blog/ConferenceAfterPartyAlcohol'),
    'construction-trades-boat-parties-austin': () => import('./pages/blog/ConstructionTradesBoatParties'),
    'corporate-team-building-on-lake-travis-alcohol-coordination-for-professional-events': () => import('./pages/blog/CorporateTeamBuildingAlcohol'),
    'corporate-team-building-on-lake-travis-professional-boat-rental-solutions': () => import('./pages/blog/CorporateTeamBuildingLakeTravis'),
    'creative-lake-travis-boat-party-themes-unique-ideas-for-memorable-celebrations': () => import('./pages/blog/CreativeLakeTravisPartyThemes'),
    'dallas-to-lake-travis-corporate': () => import('./pages/blog/DallasToLakeTravisCorporate'),
    'destination-austin-offsite-retreats': () => import('./pages/blog/DestinationAustinOffsiteRetreats'),
    'disco-cruise-fashion-part-1': () => import('./pages/blog/DiscoCruiseFashion'),
    'employee-appreciation-day-reward-your-team-with-an-easy-all-inclusive-boat-party': () => import('./pages/blog/EmployeeAppreciationDayLakeTravis'),
    'epic-bachelorette-party-austin-ultimate-guide': () => import('./pages/blog/EpicBachelorettePartyAustinGuide'),
    'epic-bachelor-party-austin-ultimate-guide': () => import('./pages/blog/EpicBachelorPartyAustinGuide'),
    'executive-retreat-alcohol-planning-balancing-professionalism-and-team-bonding': () => import('./pages/blog/ExecutiveRetreatAlcoholPlanning'),
    'graduation-party-alcohol-planning-ut-and-austin-college-celebrations': () => import('./pages/blog/GraduationPartyAlcoholPlanning'),
    'holiday-party-alcohol-themes-new-years-fourth-of-july-and-austin-celebrations': () => import('./pages/blog/HolidayPartyAlcoholThemes'),
    'how-to-throw-great-bachelorette-party-austin': () => import('./pages/blog/HowToThrowBachelorettePartyAustin'),
    'how-to-throw-great-bachelor-party-austin': () => import('./pages/blog/HowToThrowBachelorPartyAustin'),
    'integrated-austin-event-services-combining-alcohol-delivery-and-boat-rentals-for-perfect-celebrations': () => import('./pages/blog/IntegratedAustinEventServices'),
    'lake-travis-bachelorette-party-alcohol-laws-what-you-can-and-cant-bring-on-boats': () => import('./pages/blog/LakeTravisBacheloretteAlcoholLaws'),
    'lake-travis-bachelor-party-alcohol-delivery-complete-coordination-guide-for-boat-parties': () => import('./pages/blog/LakeTravisBachelorAlcoholDelivery'),
    'lake-travis-boat-party-logistics-complete-planning-and-coordination-guide': () => import('./pages/blog/LakeTravisBoatPartyLogistics'),
    'lake-travis-boat-party-packages-comprehensive-guide-to-options-and-pricing': () => import('./pages/blog/LakeTravisBoatPartyPackages'),
    'lake-travis-boat-party-regulations-legal-requirements-and-compliance-guide': () => import('./pages/blog/LakeTravisBoatPartyRegulations'),
    'lake-travis-boat-party-reviews-real-customer-experiences-and-testimonials': () => import('./pages/blog/LakeTravisBoatPartyReviews'),
    'lake-travis-boat-safety-and-maintenance-quality-standards-for-party-cruises': () => import('./pages/blog/LakeTravisBoatSafetyMaintenance'),
    'lake-travis-boat-safety-essential-guidelines-for-safe-party-cruises': () => import('./pages/blog/LakeTravisBoatSafetyGuidelines'),
    'lake-travis-party-boat-rentals-ultimate-guide-for-large-group-events-20-guests': () => import('./pages/blog/LakeTravisLargeGroupBoatRentals'),
    'lake-travis-sunset-cruises-romantic-and-celebration-options-for-every-occasion': () => import('./pages/blog/LakeTravisSunsetCruises'),
    'lake-travis-weather-planning-seasonal-considerations-for-perfect-boat-parties': () => import('./pages/blog/LakeTravisWeatherPlanning'),
    'large-group-events-lake-travis': () => import('./pages/blog/LargeGroupEventsLakeTravis'),
    'outdoor-wedding-alcohol-logistics-hill-country-and-lake-travis-coordination': () => import('./pages/blog/OutdoorWeddingAlcoholLogistics'),
    'party-alcohol-safety-in-austin-responsible-service-and-guest-well-being': () => import('./pages/blog/PartyAlcoholSafetyAustin'),
    'perfect-austin-bachelor-party-weekend': () => import('./pages/blog/PerfectAustinBachelorPartyWeekend'),
    'perfect-bachelor-party-itinerary-austin': () => import('./pages/blog/PerfectBachelorPartyItinerary'),
    'pool-party-alcohol-coordination-summer-event-planning-in-austin-heat': () => import('./pages/blog/PoolPartyAlcoholCoordination'),
    'small-business-boat-parties-austin': () => import('./pages/blog/SmallBusinessBoatParties'),
