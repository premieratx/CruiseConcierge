...
export const CURATED_OVERLAY = {
  ...
  '/bachelorette-party-austin': {
    title: 'Austin Bachelorette Party on Lake Travis — Private Boat Charters',
  ...
  '/combined-bachelor-bachelorette-austin': {
    title: 'Combined Bach Party on Lake Travis — One Boat, Both Sides | Premier',
  ...
  '/wedding-parties': {
    title: 'Lake Travis Wedding Party Boats — Welcome, Rehearsal, After-Party',
  ...
  '/family-reunion-cruise': {
    title: 'Lake Travis Family Reunion Cruises — All Ages, Shaded & Accessible',
  ...
  '/plan-your-trip': {
    title: 'Plan Your Lake Travis Party Boat Day — Directions, Uber, Parking',
  ...
  '/safety': {
    title: 'Lake Travis Party Boat Safety — 15 Years, 0 Incidents | Premier',
  ...
  '/premier-vs-float-on': {
    title: 'Premier Party Cruises vs Float On — Lake Travis Boats vs SMR Tubing',
  ...
  '/premier-vs-austin-party-boat': {
    title: 'Premier vs ATX Party Boats — Which Lake Travis Operator Wins?',
  ...
  '/what-to-bring-on-a-party-boat': {
    title: 'What to Bring on a Lake Travis Party Boat — Packing Checklist',
  ...
  '/austin-bachelorette-itinerary': {
    title: '3-Day Austin Bachelorette Itinerary with a Lake Travis Boat Day',
  ...
  '/austin-bachelor-itinerary': {
    title: '3-Day Austin Bachelor Party Itinerary — With the Lake Travis Day',
  ...
  '/combined-bach-itinerary': {
    title: 'Combined Bach Weekend Itinerary — One Couple, Both Sides | Premier',
