...
- **Quote Widget Expansion Fixed (Nov 5)**: Fixed iframe auto-expansion breaking page layout by adding 800px maximum height limit to QuoteBuilderSection.tsx and Chat.tsx. Widget now scrolls internally when content exceeds max height, preventing page layout breaks. Changed overflow from 'hidden' to 'auto' and enabled iframe scrolling.
