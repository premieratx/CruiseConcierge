...
export const corporateFAQs: FAQ[] = [
  ...
  // Corporate Services & Amenities
  {
    ...
    answer: 'Our corporate packages include: licensed, fun, experienced captains to take your group safely around the lake in style, premium sound system with microphone capabilities, climate-controlled areas, professional restrooms, cooler space (bring your own ice, or add Essentials/Ultimate packages for ice included), charging stations, and WiFi when requested. Enhanced packages include dedicated event coordinators and presentation equipment.',
    category: 'services',
    priority: 1
  },
  {
